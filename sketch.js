...
runner=createSprite(60,525,20,20)
runner.addAnimation("running",man_running)
runner.debug=false;
invisibleGround=createSprite(20,530,1000,10)
invisibleGround.visible=false;
ground=createSprite(20,530,9000,30)
...
drawSprites()
 ...
 function spawntrafficLight() {
  ...
  if (frameCount % 200 === 0) {
    var light = createSprite(900,500,40,10);
...
function spawnCars() {
  //write code here to spawn the cars
  if (frameCount % 700 === 0) {
    var car = createSprite(1000,500,40,40);
   car.addImage(carimg)
...
if (frameCount % 1000 === 0) {
    var boss = createSprite(1500,500,40,10);
...
function spawntaxi(){
	...
	if (frameCount % 200 === 0) {
    var taxi = createSprite(1300,500,40,40);
   taxi.y=Math.round(random(500,500))
   
    taxi.scale = 0.5;
    taxi.velocityX = -2;
    taxi.addImage(taximg)
     //assign lifetime to the variable
    //taxi.lifetime = 200;
    taxi.scale=0.09;
    //adjust the depth
